...
import { useDeleteNoteMutation, useUpdateNoteMutation } from '../features/notes/notesApiSlice';
...
function EditNoteForm({ note, users }) {
	...
	const onCompletedChanged = (e) => setCompleted((previous) => !previous);
	...
	if (isManager || isAdmin) {
		deleteButton = (
			<button className='edit-delete-btn' title='Delete' onClick={onDeleteNoteClicked}>
				Delete
			</button>
		);
	}
